...
if(isset($_POST['inserir'])) {
  ...
  // Função Upload (Responsável por envia o arquivo para o HD do servidor)
  upload($imagem);

  // Função inserirPost (atençaõ:mamdaremos apenas o name da imagem)
...
?>
  ...
  <div class="row">
    ...
    <!-- Adicionamos o enctype para habilitar o suporte de envio de arquivos via formulário -->
