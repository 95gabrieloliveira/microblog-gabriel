...
if( isset($_POST['entrar'])){
  //2) [IFELSE] Se os campos estão vazios
  if(empty($_POST['email']) || empty($_POST['senha'])){
    ...
    /* 3) [IFELSE] Se o usuário é diferente de nulo ou seja se tem usuário */
   if($usuario != null) {
    ...
    if(password_verify($senha, $usuario['senha'])){
      ...
      /* Caso contrário fique no login e diga que a senha esta errada */
